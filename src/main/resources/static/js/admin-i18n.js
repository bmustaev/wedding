...
const DICT = {
  en: {
    ...
    'add-guest-to-table-btn': 'Add guest here',
    ...
    'gallery-heading': 'Invitation gallery',
    'gallery-subtitle': 'Photos shown in the "About us" section of the invitation page, in this order.',
    'add-gallery-image-btn': 'Add photo',
    'gallery-empty': 'No photos yet',
    'gallery-move-up-aria': 'Move up',
    'gallery-move-down-aria': 'Move down',
    'confirm-delete-gallery-image': 'Remove this photo from the invitation gallery?',
    'add-gallery-image-modal-title': 'Add photo',
    'gallery-file-label': 'Photo',
    'gallery-caption-ru-label': 'Caption (Russian)',
    'gallery-caption-uz-label': 'Caption (Uzbek)',
    'gallery-caption-en-label': 'Caption (English)',
    'gallery-choose-file-first': 'Choose a photo first.',
    'upload-btn': 'Upload',
  ...
  ru: {
    ...
    'add-guest-to-table-btn': 'Добавить гостя сюда',
    ...
    'gallery-heading': 'Галерея приглашения',
    'gallery-subtitle': 'Фото в разделе «Немного о нас» на странице приглашения, в этом порядке.',
    'add-gallery-image-btn': 'Добавить фото',
    'gallery-empty': 'Фото пока нет',
    'gallery-move-up-aria': 'Переместить выше',
    'gallery-move-down-aria': 'Переместить ниже',
    'confirm-delete-gallery-image': 'Удалить это фото из галереи приглашения?',
    'add-gallery-image-modal-title': 'Добавить фото',
    'gallery-file-label': 'Фото',
    'gallery-caption-ru-label': 'Подпись (русский)',
    'gallery-caption-uz-label': 'Подпись (узбекский)',
    'gallery-caption-en-label': 'Подпись (английский)',
    'gallery-choose-file-first': 'Сначала выберите фото.',
